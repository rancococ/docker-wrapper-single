...
# images
images=(
wrapper-single:1.0.0-centos,registry.cn-hangzhou.aliyuncs.com/rancococ/wrapper-single:1.0-centos
wrapper-single:1.0.0-centos,registry.cn-hangzhou.aliyuncs.com/rancococ/wrapper-single:1.0.0-centos
)
