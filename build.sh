...
# images
images=(
wrapper-single:1.0.0-alpine,registry.cn-hangzhou.aliyuncs.com/rancococ/wrapper-single:1.0-alpine
wrapper-single:1.0.0-alpine,registry.cn-hangzhou.aliyuncs.com/rancococ/wrapper-single:1.0.0-alpine
)
...
docker build --rm \
             ...
             --build-arg WRAPPER_SINGLE_VERSION=3.5.41.1 \
             -t wrapper-single:1.0.0-alpine \
             -f Dockerfile .
}
